...
# ax[1].set_yscale('log')
# ax[1].plot(time[::20] / Tc, boris_gammas[::20], c='r', marker='P', ms=8, markevery=10, label='Boris')
# ax[1].plot(time[::20] / Tc, hc_gammas[::20], c='b', marker='D', ms=8, markevery=10, fillstyle='none', label='HC')
# ax[1].legend()
#
...
# ax[2].plot(time[::20] / Tc, boris_thetas[::20], c='r', marker='P', ms=8, markevery=10, label='Boris')
# ax[2].plot(time[::20] / Tc, hc_thetas[::20], c='b', marker='D', ms=8, markevery=10, fillstyle='none', label='HC')
# ax[2].legend()
#
# plt.show()