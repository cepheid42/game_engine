...
inline constexpr auto h_bar{1.054571817e-34}; // Reduced Planck's Constant, J*s

inline constexpr auto r_c{3.8615926796e-13};        // Compton radius, m
inline constexpr auto r_e{2.8179403262e-15};        // electron radius, m
inline constexpr auto alpha_fine{ 7.2973525693e-3}; // Fine structure constant, dimensionless
