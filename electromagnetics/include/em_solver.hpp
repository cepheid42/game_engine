...
namespace tf::electromagnetics {
  struct EMSolver {
    ...
    // // X-Faces
    // using Ey_x0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Ey_x1_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Ez_x0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Ez_x1_bc = BCIntegrator<PeriodicFunctor<>>;
    //
    // using Hy_x0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Hy_x1_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Hz_x0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Hz_x1_bc = BCIntegrator<PeriodicFunctor<>>;
    //
    // // Y-Faces
    // using Ex_y0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Ex_y1_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Ez_y0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Ez_y1_bc = BCIntegrator<PeriodicFunctor<>>;
    //
    // using Hx_y0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Hx_y1_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Hz_y0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Hz_y1_bc = BCIntegrator<PeriodicFunctor<>>;
    //
    // // Z-Faces
    // using Ex_z0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Ex_z1_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Ey_z0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Ey_z1_bc = BCIntegrator<PeriodicFunctor<>>;
    //
    // using Hx_z0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Hx_z1_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Hy_z0_bc = BCIntegrator<PeriodicFunctor<>>;
    // using Hy_z1_bc = BCIntegrator<PeriodicFunctor<>>;
