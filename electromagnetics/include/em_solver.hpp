...
namespace tf::electromagnetics {
  struct EMSolver {
    ...
    // Y-Faces
    using Ex_y0_bc = BCIntegrator<PMLFunctor<backward_dy, false, false>>;
    using Ex_y1_bc = BCIntegrator<PMLFunctor<backward_dy,  true, false>>;
    using Ey_y0_bc = BCIntegrator<void>;
    using Ey_y1_bc = BCIntegrator<void>;
    using Ez_y0_bc = BCIntegrator<PMLFunctor<backward_dy, false, true>>;
    using Ez_y1_bc = BCIntegrator<PMLFunctor<backward_dy,  true, true>>;

    using Hx_y0_bc = BCIntegrator<PMLFunctor<forward_dy, false, true>>;
    using Hx_y1_bc = BCIntegrator<PMLFunctor<forward_dy,  true, true>>;
    using Hy_y0_bc = BCIntegrator<void>;
    using Hy_y1_bc = BCIntegrator<void>;
    using Hz_y0_bc = BCIntegrator<PMLFunctor<forward_dy, false, false>>;
