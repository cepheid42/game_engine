...
struct EMData {
  ...
  void init_coefficients_1D(value_t);
...
template <FieldComponent EXF, FieldComponent EYF, FieldComponent EZF, FieldComponent HXF, FieldComponent HYF, FieldComponent HZF>
void EMData<EXF, EYF, EZF, HXF, HYF, HZF>::init_coefficients_1D(const value_t cfl)
{
  constexpr auto imp0 = 377.0;
  // const auto dx = 1.0 / static_cast<decltype(cfl)>(nx - 1);
...
template <FieldComponent EXF, FieldComponent EYF, FieldComponent EZF, FieldComponent HXF, FieldComponent HYF, FieldComponent HZF>
void EMData<EXF, EYF, EZF, HXF, HYF, HZF>::init_coefficients_2D(const auto cfl)
{
  constexpr auto imp0 = 377.0;
