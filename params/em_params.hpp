...
inline constexpr std::array ex_shape = {Nx - 1, Ny, Nz};
inline constexpr std::array ey_shape = {Nx, Ny - 1, Nz};
inline constexpr std::array ez_shape = {Nx, Ny, Nz - 1};
inline constexpr std::array hx_shape = {Nx, Ny - 1, Nz - 1};
inline constexpr std::array hy_shape = {Nx - 1, Ny, Nz - 1};
inline constexpr std::array hz_shape = {Nx - 1, Ny - 1, Nz};
