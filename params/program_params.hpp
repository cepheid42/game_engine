...
inline constexpr std::array x_range = {0.0, 4e+17};
inline constexpr std::array y_range = {0.0, 4e+17};
inline constexpr std::array z_range = {0.0, 4e+17};

inline constexpr auto dx = 2.6666666666666668e+16;
inline constexpr auto dy = 2.6666666666666668e+16;
inline constexpr auto dz = 2.6666666666666668e+16;

inline constexpr auto cfl   = 1.9472091336823453e-05;
inline constexpr auto dt    = 1000.0;
inline constexpr auto t_end = 1000000000.0;
inline constexpr auto Nt    = 1000001zu;

inline constexpr auto sim_name = "uniform_E_field";
...
inline constexpr auto em_save_interval = 1000zu;
...
inline constexpr auto applied_fields_path = "/home/cepheid/TriForce/game_engine/data/uniform_E_field/uniform_E_field_applied_fields.bp";
...
inline constexpr auto particle_save_interval = 1000zu;
...
inline constexpr std::array<ParticleGroupSpec, 1> particle_spec = {
   ParticleGroupSpec{
      .name = "singleton",
      .filepath = "/data/uniform_E_field/singleton.bp",
      .mass = 1.0,
...
inline constexpr auto metric_data_path = "/home/cepheid/TriForce/game_engine/data/uniform_E_field";
