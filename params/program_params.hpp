...
inline constexpr std::array x_range = {0.0, 0.001};
inline constexpr std::array y_range = {0.0, 0.001};
inline constexpr std::array z_range = {0.0, 0.001};
...
inline constexpr auto Ncx = 10zu;
inline constexpr auto Ncy = 10zu;
inline constexpr auto Ncz = 10zu;
