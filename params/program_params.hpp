...
inline constexpr auto sim_name = "lsi_collisions";
...
inline constexpr std::array<collision_spec, 3> collision_params = {
   std::tuple("electrons", "ions", 0.0, 1.0, 50, false),
   std::tuple("electrons", "electrons", 0.0, 1.0, 50, true),
   std::tuple("ions", "ions", 0.0, 1.0, 50, true),
};
