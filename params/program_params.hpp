...
inline constexpr std::array collision_spec = {
   CollisionSpec{
      ...
      .radiation = {
         .product1 = "photons",
         .cross_section_file = "/tests/cross_section_data/SB_G4_Z29_kdsdk_barns.csv",
