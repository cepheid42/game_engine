...
inline constexpr auto Nt    = 7501lu;
...
inline constexpr auto em_save_interval = 75lu;
...
inline constexpr auto particle_save_interval = 75lu;
...
inline constexpr std::array<collision_spec, 0> collision_params = {};
