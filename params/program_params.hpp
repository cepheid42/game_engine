...
//
// inline constexpr std::array x_range = {-1.0e-6_fp, 1.0e-6_fp};
// inline constexpr std::array y_range = {0.0_fp, 2.0e-8_fp}; // 40 nm
// inline constexpr std::array z_range = {-1.0e-6_fp, 1.0e-6_fp};
...
// inline constexpr auto total_time = 2.0e-13_fp; // 30 fs
