...
inline constexpr std::array x_range = {-1.1, 1.1};
inline constexpr std::array y_range = {-1.1, 1.1};
inline constexpr std::array z_range = {-1.1, 1.1};

inline constexpr auto dx = 0.14666666666666667;
