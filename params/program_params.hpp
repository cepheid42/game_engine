...
inline constexpr std::size_t chunkSize = 500;

inline constexpr std::size_t Nx = 1501; //1501;
inline constexpr std::size_t Ny = 2;
inline constexpr std::size_t Nz = 1501;
inline constexpr std::size_t nHalo = 0zu;

inline constexpr std::array x_range = {-15.0e-6_fp, 15.0e-6_fp};//{-3.0e-6_fp, 12.0e-6_fp};
...
// inline constexpr std::size_t Ncells = Ncx * Ncy * Ncz;
